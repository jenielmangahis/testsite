...
function graphene_update_db(){
	...
	$graphene_settings['about_page'] = get_option('graphene_about_page');
	$graphene_settings['privacypolicy_page'] = get_option('graphene_privacypolicy_page');
	$graphene_settings['contact_page'] = get_option('graphene_contact_page');
	$graphene_settings['sitemap_page'] = get_option('graphene_sitemap_page');
	
	$graphene_settings['show_singleadsense'] = get_option('graphene_show_singleadsense');
	$graphene_settings['width_adsense'] = get_option('graphene_width_adsense');
	$graphene_settings['height_adsense'] = get_option('graphene_height_adsense');
	$graphene_settings['singleadsense_code'] = get_option('graphene_singleadsense_code');
	$graphene_settings['topposition_adsense'] = get_option('graphene_topposition_adsense');
	$graphene_settings['bottomposition_adsense'] = get_option('graphene_bottomposition_adsense');
	...
	$graphene_settings['header_color'] = get_option('graphene_header_color');
	...
	$graphene_settings['disable_headertitle'] = get_option('graphene_disable_headertitle');
	$graphene_settings['logomargin_left'] = get_option('graphene_logomargin_left');
	$graphene_settings['logomargin_top'] = get_option('graphene_logomargin_top');
	
	$graphene_settings['menu_position'] = get_option('graphene_menu_position');
	
	$graphene_settings['disable_header'] = get_option('graphene_disable_header');
	
	$graphene_settings['round_corners_topleft'] = get_option('graphene_round_corners_topleft');
	$graphene_settings['round_corners_topright'] = get_option('graphene_round_corners_topright');
	$graphene_settings['round_corners_bottomleft'] = get_option('graphene_round_corners_bottomleft');
	$graphene_settings['round_corners_bottomright'] = get_option('graphene_round_corners_bottomright');
	
	$graphene_settings['menuround_corners_topleft'] = get_option('graphene_menuround_corners_topleft');
	$graphene_settings['menuround_corners_topright'] = get_option('graphene_menuround_corners_topright');
	$graphene_settings['menuround_corners_bottomleft'] = get_option('graphene_menuround_corners_bottomleft');
	$graphene_settings['menuround_corners_bottomright'] = get_option('graphene_menuround_corners_bottomright');
	
	$graphene_settings['menuexclude_pages'] = get_option('graphene_menuexclude_pages');
	$graphene_settings['sidebar_exclude_categories'] = get_option('graphene_sidebar_exclude_categories');
	
	$graphene_settings['show_headerads'] = get_option('graphene_show_headerads');
	$graphene_settings['headerads_code'] = get_option('graphene_headerads_code');
	$graphene_settings['leftposition_headerads'] = get_option('graphene_leftposition_headerads');
	$graphene_settings['topposition_headerads'] = get_option('graphene_topposition_headerads');
	
	$graphene_settings['show_headerafterads'] = get_option('graphene_show_headerafterads');
	$graphene_settings['headerafterads_code'] = get_option('graphene_headerafterads_code');
	
	$graphene_settings['homepage_description'] = get_option('graphene_homepage_description');
	...
	if (update_option('graphene_settings', $graphene_settings)) {
		...
		delete_option('graphene_about_page');	
		delete_option('graphene_privacypolicy_page');	
		delete_option('graphene_contact_page');	
		delete_option('graphene_sitemap_page');
		
		delete_option('graphene_show_singleadsense');	
		delete_option('graphene_width_adsense');	
		delete_option('graphene_height_adsense');	
		delete_option('graphene_singleadsense_code');
		delete_option('graphene_topposition_adsense');	
		delete_option('graphene_bottomposition_adsense');		
		...
		delete_option('graphene_header_color');
		...
		delete_option('graphene_disable_headertitle');
		delete_option('graphene_logomargin_left');
		delete_option('graphene_logomargin_top');
		
		delete_option('graphene_menu_position');
		
		delete_option('graphene_disable_header');
		
		delete_option('graphene_round_corners_topleft');
		delete_option('graphene_round_corners_topright');
		delete_option('graphene_round_corners_bottomleft');
		delete_option('graphene_round_corners_bottomright');
		
		delete_option('graphene_menuround_corners_topleft');
		delete_option('graphene_menuround_corners_topright');
		delete_option('graphene_menuround_corners_bottomleft');
		delete_option('graphene_menuround_corners_bottomright');
		
		delete_option('graphene_menuexclude_pages');
		delete_option('graphene_sidebar_exclude_categories');
		
		delete_option('graphene_show_headerads');
		delete_option('graphene_headerads_code');
		delete_option('graphene_leftposition_headerads');
		delete_option('graphene_topposition_headerads');
		
		delete_option('graphene_show_headerafterads');
		delete_option('graphene_headerafterads_code');
		
		delete_option('graphene_homepage_description');
