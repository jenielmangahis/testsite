			...
			$('.social-media-table tbody').append('\
					...
					<tr class="new-social-media">\
						...
						<td>\
							...
							<span class="description"><?php printf( esc_js( __( 'URL to the social media icon. Note: the theme uses the %s icon set for the social media icons. The icon size must have 32x32. Please do not hotlink the icons on the site. Download the icons you need and upload them to your server instead.', 'graphene' ) ), '<a href="http://www.iconfinder.com/search/?q=iconset%3Asocialmediabookmark">Social Media Bookmark</a>' ); ?></span>\
						</td>\
					</tr>\
			');
			count++;
