...
function graphene_add_meta_box(){
	add_meta_box( 'graphene_custom_meta', __( 'Crystal post-specific options','graphene' ), 'graphene_custom_meta', 'post', 'normal', 'high' );
	add_meta_box( 'graphene_custom_meta', __( 'Crystal page-specific options','graphene' ), 'graphene_custom_meta', 'page', 'normal', 'high' );
}
...
function graphene_custom_meta( $post){ 
	...
	<p><?php _e("These settings will only be applied to this particular post or page you're editing. They will override the global settings set in the Crystal Options or Crystal Display options page.", 'graphene' ); ?></p>
