<?php if (have_posts()) : ?>
	<?php while (have_posts()) : the_post(); global $graphene_settings; ?>
		...
		*/ 
        ...
        <?php if($graphene_settings['show_singleadsense'] === true && $graphene_settings['topposition_adsense'] === true && !empty($graphene_settings['singleadsense_code']) && !is_page() && !is_front_page()){ ?>
            <div style="width:<?php echo $graphene_settings['width_adsense']; ?>px;height:<?php echo $graphene_settings['height_adsense']; ?>px; margin:0 auto; margin-bottom:10px;">
                <?php echo $graphene_settings['singleadsense_code']; ?>
            </div>
        <?php } ?>
        ...
        <?php if($graphene_settings['show_singleadsense'] === true && $graphene_settings['bottomposition_adsense'] === true && !empty($graphene_settings['singleadsense_code']) && !is_page() && !is_front_page()){ ?>
            <div style="width:<?php echo $graphene_settings['width_adsense']; ?>px;height:<?php echo $graphene_settings['height_adsense']; ?>px; margin:0 auto; margin-top:10px;">
                <?php echo $graphene_settings['singleadsense_code']; ?>
            </div>
        <?php } ?>
        <?php endif; ?>
