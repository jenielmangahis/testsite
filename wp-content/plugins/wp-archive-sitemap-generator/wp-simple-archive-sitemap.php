...
Plugin URI: http://arpitshah.com/plugins/wp-archive-sitemap-generator/
...
function wp_archive_sitemap_generator($text) {
	...
	if (preg_match("|<!--wp-archive-sitemap-generator-->|", $text)) {
		...
		$pluginlink = "http://bit.ly/wp-archive-sitemap-generator";
		$target1 = "_blank";
		...
		{
			$sponsor_link1 = '<font size="1"><br/><i> Generated by: <a href="http://bit.ly/wp-archive-sitemap-generator" target="_blank">WP Archive-Sitemap Generator</a></i></font>';
		}
		...
		<div style="float:left;width:60%;">
		 ...
		 <div id="side-info-column" class="inner-sidebar">
				<div class="postbox">
				  ...
				  <div class="inside">
	                <ul>
	                <li><a href="http://arpitshah.com/plugins/wp-archive-sitemap-generator/" title="WP Archive-Sitemap Generator" target="_blank">Plugin Homepage</a></li>
	                </ul>
	              </div>
				</div>
     </div>
			...
			<div id="side-info-column" class="inner-sidebar">
				<div class="postbox">
				  ...
				  <div class="inside">
					...
					<li>3) <a href="http://arpitshah.com/plugins/all-in-one-webmaster/" title="All in One Webmaster" target="_blank">All in One Webmaster</a></li>
